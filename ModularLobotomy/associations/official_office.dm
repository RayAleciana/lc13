...
/obj/item/attribute_increase/fixer/office
	...
	desc = "A fluid used to increase the stats of a non-association fixer. Use in hand to activate. Gives double the stats of a normal accelerator. Increases stats more the lower your potential. Effects eveyone a part of your office."
	amount = 1
